...
public class PedidosSpecs {
    ...
    public static Specification<Pedido> emailClienteLike(String email){
        return (root, query, criteriaBuilder) ->
                email == null ? null :
                        criteriaBuilder.like(root.join("cliente").get("email"), email);
    }

    public static Specification<Pedido> telefoneClienteLike(String telefone){
        return (root, query, criteriaBuilder) ->
                telefone == null ? null :
                        criteriaBuilder.like(root.join("cliente").get("telefone"), telefone);
    }
    ...
    public static Specification<Pedido> nomeLaboratorioLike(String nomeLaboratorio){
        return (root, query, criteriaBuilder) ->
                nomeLaboratorio == null ? null :
                        criteriaBuilder.like(root.join("laboratorio").get("nome"), nomeLaboratorio);
    }

    public static Specification<Pedido> enderecoLaboratorioLike(String enderecoLaboratorio){
        return (root, query, criteriaBuilder) ->
                enderecoLaboratorio == null ? null :
                        criteriaBuilder.like(root.join("laboratorio").get("endereco"), enderecoLaboratorio);
    }

    public static Specification<Pedido> custoEqual(BigDecimal custo){
        return (root, query, criteriaBuilder) ->
                custo == null ? null :
    ...
    public static Specification<Pedido> armacaoLike(String armacao){
        return (root, query, criteriaBuilder) ->
                armacao == null ? null :
                        criteriaBuilder.like(root.get("armacao"), armacao);
    }
    ...
    public static Specification<Pedido> tratamentoLike(String tratamento){
        return (root, query, criteriaBuilder) ->
                tratamento == null ? null :
                        criteriaBuilder.like(root.get("tratamento"), tratamento);
    }

    public static Specification<Pedido> tipoLenteLike(String tipoLente){
        return (root, query, criteriaBuilder) ->
                tipoLente == null ? null :
                        criteriaBuilder.like(root.get("tipoLente"), tipoLente);
    }
